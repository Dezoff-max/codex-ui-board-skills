...
This roadmap describes practical improvements for making Codex UI Board Skills more useful, reliable, and contributor-friendly.

## Phase 1 - Documentation and Polish
...
- [ ] Add a mobile-first UI board skill.
- [ ] Add a finance dashboard UI board skill.
- [ ] Add an admin panel UI board skill.
- [ ] Add a landing page UI board skill.
- [ ] Add a data-heavy analytics board skill.
- [ ] Add a compact settings and preferences board skill.
- [ ] Add more domain-specific prompt examples for SaaS, AI tools, internal tools, and productivity apps.
...
- [x] Add automated screenshot generation for `preview.html`.
